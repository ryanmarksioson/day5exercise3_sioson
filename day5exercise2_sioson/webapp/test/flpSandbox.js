		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise2sioson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise2sioson-display": {
								"semanticObject": "zbtpday5exercise2sioson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise2sioson",
									"url": sap.ui.require.toUrl("zbtp/day5exercise2sioson")
								}
							}
						}
					}
