		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1sioson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1sioson-display": {
								"semanticObject": "zbtpday5exercise1sioson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1sioson",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1sioson")
								}
							}
						}
					}
